...
df2 = pd.DataFrame()
df3 = pd.DataFrame()
client9 = boto3.session.Session(aws_access_key_id="IASIAWUH6QJOWHNVX47XN",aws_secret_access_key="DwgjuWJ1pnNfyEHWptDpewIkpEY5EYKmfDUs8hBN",aws_session_token="")
client = boto3.client9('autoscaling',region_name="us-west-2")
client1 = boto3.client9('ec2',region_name="us-west-1")
