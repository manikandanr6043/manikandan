...
client = boto3.client('autoscaling',region_name="us-west-2",aws_access_key_id='ASIAWUH6QJOWHNVX47XN',aws_secret_access_key='DwgjuWJ1pnNfyEHWptDpewIkpEY5EYKmfDUs8hBN')
client1 = boto3.client('ec2',region_name="us-west-2",aws_access_key_id='ASIAWUH6QJOWHNVX47XN',aws_secret_access_key='DwgjuWJ1pnNfyEHWptDpewIkpEY5EYKmfDUs8hBN')
